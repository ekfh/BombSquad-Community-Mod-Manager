...
def bsGetGames():
    return [StickyRaceGame]
  
def bsGetLevels():
    return [bs.Level('Sticky Race',displayName='${GAME}',gameType=StickyRaceGame,settings={},previewTexName='bigGPreview'),
            bs.Level('Epic Sticky Race',displayName='${GAME}',gameType=StickyRaceGame,settings={'Epic Mode':True},previewTexName='bigGPreview')]
...
class StickyRaceGame(bs.TeamGameActivity):
    ...
    def getSettings(cls,sessionType):
        return [("Laps",{'minValue':1,"default":6,"increment":1}),
                ...
                ("Bomb Spawning",{'choices':[('None',0),('8 Seconds',8000),
                                             ('4 Seconds',4000),('2 Seconds',2000),('1 Second',1000)],'default':1000}),
        ...
        if lastRegion != thisRegion:
            ...
            if thisRegion > lastRegion + 2:
                if player.isAlive():
                    ...
                    bs.screenMessage(bs.translate(u'statements',u"Killing ${NAME} for skipping part of the track!").replace(u'${NAME}',player.getName()),color=(1,0,0))
            else:
    ...
    def _spawnBombAtPt(self,pt):
        ...
        bs.Bomb(position=pt,bombType='sticky').autoRetain()
