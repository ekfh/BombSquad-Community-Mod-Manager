...
class BrainFreezeGame(bs.TeamGameActivity):
    ...
    def getDescription(cls,sessionType):
        return 'Blow it up at any time careful game might crash'
    ...
    def onBegin(self):
        ...
        self._meteorTime = 10
        t = 10 if len(self.players) > 2 else 10
    ...
    def _dropBomb(self,position,velocity):
        b = bs.Bomb(position=position,velocity=velocity,bombType='tnt').autoRetain()
