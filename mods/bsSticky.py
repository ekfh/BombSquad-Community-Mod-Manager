...
def bsGetLevels():
    return [bs.Level('Sticky Shower',displayName='${GAME}',gameType=MeteorShowerGame,settings={},previewTexName='rampagePreview'),
            bs.Level('Epic Sticky Shower',displayName='${GAME}',gameType=MeteorShowerGame,settings={'Epic Mode':True},previewTexName='rampagePreview')]

class MeteorShowerGame(bs.TeamGameActivity):

    @classmethod
    def getName(cls):
        return 'Sticky Shower'
    ...
    def getDescription(cls,sessionType):
        return 'Dodge the falling sticky bombs.'
    ...
    def _dropBomb(self,position,velocity):
        b = bs.Bomb(position=position,velocity=velocity,bombType='sticky').autoRetain()
