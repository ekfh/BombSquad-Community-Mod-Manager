...
def bsGetLevels():
    return [bs.Level('Mine Shower',displayName='${GAME}',gameType=MeteorShowerGame,settings={},previewTexName='rampagePreview'),
            bs.Level('Epic Mine Shower',displayName='${GAME}',gameType=MeteorShowerGame,settings={'Epic Mode':True},previewTexName='rampagePreview')]
...
class MeteorShowerGame(bs.TeamGameActivity):
    ...
    def getDescription(cls,sessionType):
        return 'Dodge the falling mines.'
    ...
    def _dropBomb(self,position,velocity):
        b = bs.Bomb(position=position,velocity=velocity,bombType='landMine').autoRetain()
        b.arm()
