...
def bsGetLevels():
	...
	return [bs.Level('Newbie Training Ground', # globally-unique name for this level (not seen by user)
...
class TheArenaGame(bs.CoopGameActivity):
    ...
    @classmethod
    def getName(cls):
        return "EKFH's Newbie Arena"

    @classmethod
    def getDescription(cls,sessionType):
        return "Training ground for Newbies."
    ...
    def _startBotUpdates(self):
        self._botUpdateInterval = 3500 - 500*(len(self.players))
        self._updateBots()
        self._updateBots()
    ...
    def handleMessage(self,m):
        ...
        if isinstance(m,bs.PlayerSpazDeathMessage):
            ...
            respawnTime = len(self.initialPlayerInfo)*50
