...
class State:
	def __init__(self, bomb=None, grab=True, punch=True, curse=True, required=False, final=False, name=""):
		self.bomb = bomb
		self.grab = grab
		self.punch = punch
		self.pickup = False
...
class ArmsRace(bs.TeamGameActivity):
	...
	def getDescription(cls, sessionType):
		return "Just be destructive."

	def getInstanceDescription(self):
		return 'Just be destructive.'

	def getInstanceScoreBoardDescription(self):
		return 'Just be destructive.'.format(len(self.states))
