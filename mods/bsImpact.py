...
def bsGetLevels():
    return [bs.Level('Impact Shower',displayName='${GAME}',gameType=MeteorShowerGame,settings={},previewTexName='rampagePreview'),
            bs.Level('Epic Impact Shower',displayName='${GAME}',gameType=MeteorShowerGame,settings={'Epic Mode':True},previewTexName='rampagePreview')]

class MeteorShowerGame(bs.TeamGameActivity):

    @classmethod
    def getName(cls):
        return 'Impact Shower'
    ...
    def getDescription(cls,sessionType):
        return 'Dodge the falling impact bombs.'
