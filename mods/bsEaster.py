...
def bsGetLevels():
    return [bs.Level('Easter Egg Hunt', displayName='${GAME}', gameType=EasterEggHuntGame, settings={}, previewTexName='towerDPreview'),
            bs.Level('Pro Easter Egg Hunt', displayName='Pro ${GAME}', gameType=EasterEggHuntGame, settings={'Pro Mode':True}, previewTexName='towerDPreview')
    ]
